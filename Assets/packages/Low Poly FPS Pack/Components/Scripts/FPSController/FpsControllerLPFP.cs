...
#pragma warning disable 649
        ...
        public touchController mobileController;
...
#pragma warning restore 649
        ...
        {
            get { return touch.TouchDist.x * mouseSensitivity; }
        }

        /// Returns the target rotation of the camera around the x axis with no smoothing.
        private float RotationYRaw
        {
            get { return touch.TouchDist.y * mouseSensitivity; }
        }
        ...
        {
            var direction = new Vector3(floatingJoystick.Horizontal, 0f, floatingJoystick.Vertical).normalized;
        ...
        private void Jump()
        {
            if (!_isGrounded || !mobileController.jump) return;
            mobileController.jump = false;
